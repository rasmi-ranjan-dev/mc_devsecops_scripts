    ...
    steps {
        ...
        script {
            ...
            parallel { 
                    ...
                    when {
                        beforeAgent true
                        expression { !(params.SKIP_ALL || params.SKIP_CVC) }
                    }
                   ...
                   stage('OSS') {
                    ...
                    when {
                        beforeAgent true
                        expression { !(params.SKIP_ALL || params.SKIP_OSS) }
                    }
                    stages {
                        ...
                        stage('OSS tasks in parallel') {
                            steps {
                                script {
                                    ...
                                    def isRecert = (params.RECERTIFICATION ?: 'NO').trim().toUpperCase() == 'YES'
                 ...
                 stage('SAST') {
                      when {
                        beforeAgent true
                        expression { !(params.SKIP_ALL || params.SKIP_SAST) }
                    }
